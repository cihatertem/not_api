"""
Django settings for not_api project.
...
ALLOWED_HOSTS = [getenv('ALLOWED_ONE'), getenv('ALLOWED_TWO')]
...
WSGI_APPLICATION = 'not_api.wsgi.application'
